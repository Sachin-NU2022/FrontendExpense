...
const ExpenseCategoryList = () => {
   ...
   const { errors, validationForm, onBlurField } = useFormValidCat(category);
                                                ...
                                                <Row>
                                                   <Col md="12">
                                                      <FormGroup>
                                                         ...
                                                         <Input type="text" id="expense_category_name" name="expense_category_name" onChange={onUpdateField} className="inputdesign" />
